...
('jg7g6e2zk2ie7g1lkhl4ds4tpvrz470a','.eJyrVsrJTFGystBRKgLRhjpKqVA6JbEkVclKycjAyEjXwFzX0FhJRykXKleSX5KYo2RlbGpgUAsARjgRMQ:1oCJHh:XmUSJZxdw1IMXZEZzRvYtIFXvsu-We7zpo1TLL9jCj4','2022-07-29 11:15:01.013304');
...
(1,'HDFC','HDFC0002345',1820,123456789,596500);
...
insert  into `resortapp_booking`(`id`,`number_of_persn`,`adults`,`childrens`,`date_arrival`,`date_vaccate`,`status`,`booking_date`,`facilities_id_id`,`package_id_id`,`room_id_id`,`user_id_id`) values 
(1,5,3,2,'2022-07-09','2022-07-10','accept','2022-06-30',1,1,1,2),
(2,4,2,2,'2022-07-08','2022-07-16','pending','2022-07-01',1,1,2,3);
...
(3,'Arun','MK','Sopanam','Kallayi','Areekode',673204,'Kerala','Malapuram',897653092,'male','1993-06-25',325476897654,6000,'KITCHEN','Cleaning','WIN_20210303_15_36_05_Pro_I7m6y7p.jpg',7),
(4,'Shobana','S','Kallulathil','Kadathanadankallu','Manarkade',670906,'Kerala','Palakkad',9876567876,'Female','1990-09-12',234565437890,7000,'ROOM','Bed Setting','WhatsApp Image 2021-07-31 at 1.56.16 PM_Wsl8JLn.jpeg',8);
...
(1,'pending','black and grey baloons','2022-07-08',1,3),
(2,'pending',' Use Yellow Flowers Decorations','2022-08-04',2,2);
...
(3,'2022-07-15','pending','Sudden bike accident','2022-07-15',4,'2022-07-15');
...
(1,'Burgers','cheesy',350,90,'food1_9RKg5km.jpg'),
(2,'vegitable fried rice','Chilli Paneer and Veg Fried Rice Combo ',400,100,'veg_fridrice.JPG'),
...
insert  into `resortapp_offers`(`id`,`number_of_persn`,`rate`,`start_date`,`end_date`,`offer_price`,`package_id_id`) values 
(1,4,6000,'2022-07-06','2022-07-09',4000,1);
...
(1,'Summer Package',8000,'package_xWZeyHm.jpg','fully wi-fi\r\nswimming pool\r\nchildrens play area','2022-07-01 00:00:00.000000','2022-07-10 00:00:00.000000');
...
insert  into `resortapp_room`(`id`,`room_number`,`room_facility`,`number_of_persons`,`description`,`photo`,`rate`,`cottage_id_id`) values 
(1,'A001','DOUBLE COT BED',4,'full wi-fi facilities\r\n','room2_oNA0LEj.jpg',12000,1),
(2,'4','DOUBLE COT BED',4,'extra kitchen area','room4.jpg',4000,2);
